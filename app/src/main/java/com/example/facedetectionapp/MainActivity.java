        ...
        detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
            ...
            public void onSuccess(List<FirebaseVisionFace> firebaseVisionFaces) {
                ...
                for(FirebaseVisionFace face : firebaseVisionFaces)
                {
                    resultText=resultText.concat("\n"+i+".")
                            .concat("\nsmile: "+face.getSmilingProbability()*100+"%")
                             .concat("\nlefteyeOPen: "+face.getLeftEyeOpenProbability()*100+"%")
                             .concat("\nRighteyeOPen: "+face.getRightEyeOpenProbability()*100+"%");
                    i++;
                }
                ...
                }else
                {
                    ...
                    resultDialog.show(getSupportFragmentManager(),LCOFaceDetection.Result_Dialouge);
